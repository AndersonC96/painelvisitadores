...
<section class="section" style="min-height:85vh; display:flex; align-items:center;">
  <div class="container" style="max-width:520px; margin:auto;">
    <div class="box" style="
      ...
      <form method="POST" action="/representantes/update" autocomplete="off">
        <input type="hidden" name="id" value="<?= $representante['id'] ?>">
        <div class="field">
          <label class="label">Nome</label>
          <div class="control">
            <input class="input" type="text" name="nome" value="<?= htmlspecialchars($representante['nome']) ?>" required maxlength="120" autofocus>
          </div>
        </div>
        <div class="field">
        ...
        <div class="field" style="margin-top:8px;">
          <label class="checkbox" style="font-weight:700;letter-spacing:.1em;">
            <input type="checkbox" name="ativo" <?= $representante['ativo'] ? 'checked' : '' ?> style="margin-right:7px;">
            Ativo
          </label>
        </div>
